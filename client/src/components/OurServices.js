...
const OurServices= () =>{
    ...
    <div className="flex-section">
        <div>
        <h4> Team of qualified doctors</h4>
        ...
        <h4> Analysis laboratories</h4> <img  style={{width:'400px',height:'200px'
          
        }}src='https://image.freepik.com/photos-gratuite/personnel-du-laboratoire-medical-discutant-resultats-tests_160672-5725.jpg'/>
        <p>
        ...
        }}src='https://image.freepik.com/photos-gratuite/vue-dessus-voyageur-portant-masque-medical-carte-pointage-sac-dos-fond-jaune_179666-41137.jpg'/>
        <p>
          Inform you of the nearest oxygen centers.
        </p></div>
<div>     
        <h4> The mediacl file </h4><img  style={{width:'400px',height:'200px'
          
        }}src='https://image.freepik.com/photos-gratuite/medecin-notant-symptomes-patient_53876-63308.jpg'/>
